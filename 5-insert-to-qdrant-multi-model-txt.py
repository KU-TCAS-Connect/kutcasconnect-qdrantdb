...
def create_collection():
    client.create_collection(
        ...
        vectors_config=VectorParams(
            size=768,  # Size for the dense vector (size of 'paraphrase-multilingual-MiniLM-L12-v2')
...
def process_and_insert_data(df):
    ...
    for _, row in df.iterrows():
        ...
        # Generate SentenceTransformer embeddings for the chunks
        ...
        for i, chunk in enumerate(chunks):
            ...
            data = {
                ...
                "contents": chunk,
                "embedding": st_embeddings[i],  # Use the SentenceTransformer embedding here
            }
